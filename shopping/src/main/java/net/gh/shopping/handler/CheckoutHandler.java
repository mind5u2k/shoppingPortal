package net.gh.shopping.handler;
...
import net.gh.shopping.model.CheckoutModel;
import net.gh.shopping.model.UserModel;
import net.gh.shoppingBack.dao.CartLineDAO;
import net.gh.shoppingBack.dao.ProductDAO;
import net.gh.shoppingBack.dao.UserDAO;
import net.gh.shoppingBack.dto.Address;
import net.gh.shoppingBack.dto.Cart;
import net.gh.shoppingBack.dto.CartLine;
import net.gh.shoppingBack.dto.OrderDetail;
import net.gh.shoppingBack.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public List<Address> getShippingAddresses(CheckoutModel model) {
		...
		addresses.add(addresses.size(),
				userDAO.getBillingAddress(model.getUser().getId()));

		return addresses;

	}

	public String saveAddressSelection(CheckoutModel checkoutModel,
			int shippingId) {
